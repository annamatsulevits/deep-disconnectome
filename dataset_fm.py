...
class Normal_dataset(Dataset):
	...
	def __init__(self, data_root, csv, transformX=None, transformY=None, transform_lesion = None, return_file_info=False, device=None):
...
# 		out_path = self.disco_paths[idx]
		...
		wm_mask = self.wm_mask
		out_path = self.csv.loc[idx, 'disc']
